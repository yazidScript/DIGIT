...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="row justify-content-center">
     <div class="col-md-6">
         <div class="card">
             <div class="card-header bg-success text-white text-left text-weight-bold">Masuk</div>
             ...
             <div class="card-body">
                 <form method="POST" action="/login/admin">
                     ...
                     <div class="form-group row {{ $errors->has('name') ? ' has-error' : '' }}">
                         ...
                         <div class="col-md-6">
                         <input name="username" type="text" class="form-control" id="signin-name" placeholder="" autocomplete="off">
                         </div>
                     ...
                     <div class="form-group row {{ $errors->has('password') ? ' has-error' : '' }}">
                         ...
                         <div class="col-md-6">
                         <input name="password" type="password" class="form-control" id="signin-password" placeholder="">
                         </div>

                     </div>
                     <div class="text-center">
                         <button class="btn btn-success col-md-9 mx-auto btn-block my-4" type="submit">Masuk</button>
                     </div>
                 </form>
             </div>
         </div>
